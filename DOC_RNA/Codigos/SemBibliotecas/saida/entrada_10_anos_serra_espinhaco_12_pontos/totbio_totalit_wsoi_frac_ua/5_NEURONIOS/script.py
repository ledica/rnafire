...
N_NEURONIOS=5
frequencia_teste=1000
variaveis_entrada="totbio totalit wsoi frac ua"
...
path_output='saida/'+name_exp+'/totbio_totalit_wsoi_frac_ua/'+str(N_NEURONIOS)+'_NEURONIOS/'
        ...
        while err10 > 0.000000009:
            ...
            for i in range(self.max_interacoes):
                ...
                if i % frequencia_teste == 0:
                    ...
                    binary_file = open(path_output+'rna.bin',mode='wb')
...
def plotResultado(indice,validacao,erro):
    ...
    plt.title("Simulacao Fogo RNA - Serra do Espinhaco")
